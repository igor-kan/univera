# Contributing to univera

Thank you for your interest in contributing to univera! This document provides guidelines and instructions for contributing to this project.
...
3. **Add the upstream remote**:
   ```bash
   git remote add upstream https://github.com/igor-kan/univera.git
   ```
...
By contributing to univera, you agree that your contributions will be licensed under the project's [MIT License](LICENSE).
